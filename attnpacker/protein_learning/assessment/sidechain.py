...
from attnpacker.protein_learning.protein_utils.sidechains.project_sidechains import (
    compute_sc_rmsd,
    compute_clashes
)
...
from attnpacker.protein_learning.common.helpers import safe_normalize, default, masked_mean
...
from attnpacker.protein_learning.protein_utils.sidechains.sidechain_utils import align_symmetric_sidechains, get_sc_dihedral
