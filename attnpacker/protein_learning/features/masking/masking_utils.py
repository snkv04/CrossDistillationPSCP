...
from attnpacker.protein_learning.features.feature_config import FeatureName, FeatureTy
from attnpacker.protein_learning.features.input_features import Feature
