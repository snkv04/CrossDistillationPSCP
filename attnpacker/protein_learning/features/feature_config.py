...
from attnpacker.protein_learning.features.constants import SMALL_SEP_BINS, DEFAULT_PW_DIST_RADII
...
class InputFeatureConfig(NamedTuple):
    ...
    sc_dihedral_encode_dim: int = 24    # Added for autoregressive PSCP network
