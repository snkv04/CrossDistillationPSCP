...
from attnpacker.protein_learning.features.masking.masking_utils import get_partition_mask
from attnpacker.protein_learning.common.io.utils import load_npy
