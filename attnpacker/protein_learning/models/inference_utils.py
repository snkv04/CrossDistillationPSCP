...
from attnpacker.protein_learning.common.protein_constants import AA_TO_SC_ATOMS, BB_ATOMS, NAT_AA_SET

import attnpacker.protein_learning.models.model_abc.train as sc
