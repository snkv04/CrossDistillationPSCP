...
from attnpacker.protein_learning.networks.attention.node_attention import NodeUpdateBlock
from attnpacker.protein_learning.networks.attention.pair_attention import PairUpdateBlock
