...
from attnpacker.protein_learning.common.helpers import default
from attnpacker.protein_learning.common.io.select_atoms import SelectCG, SelectCB
from attnpacker.protein_learning.common.protein_constants import VALID_AA_3_LETTER, VALID_AA_1_LETTER
...
def get_structure_parser(pdb_file: str) -> Union[PDBParser, MMCIFParser]:
    ...
    """
    is_pdb, is_cif = [str(pdb_file).endswith(x) for x in (".pdb", ".cif")]
