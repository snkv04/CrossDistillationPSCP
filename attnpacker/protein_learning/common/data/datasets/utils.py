...
from attnpacker.protein_learning.networks.loss.coord_loss import CoordDeviationLoss
from attnpacker.protein_learning.networks.loss.coord_loss import TMLoss
